...
if (isset($_SESSION['id_user'])) {
    ...
    $data = mysqli_query($koneksi, "SELECT * FROM tbl_user WHERE id_user='$idm'");

    // Periksa apakah query mengembalikan baris
    if ($data && mysqli_num_rows($data) > 0) {
        $row = mysqli_fetch_array($data);
    } else {
        // Jika tidak ada baris yang ditemukan, berikan pesan kesalahan atau redirect
        echo "Data tidak ditemukan.";
        exit();
    }
} else {
    // Jika id_user tidak ada di sesi, berikan pesan kesalahan atau redirect
    echo "Session id_user tidak ditemukan.";
    exit();
}
?>
                ...
                ?>
                  ...
                  <form action="update-akun.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      <div class="col-lg-3">
                       <label for="subjek" class="text-primary">NIK</label>
                      </div>
                      <div class="col-lg-7">
                       <input type="text" class="form-control" value="<?php echo isset($row['nik']) ? $row['nik'] : ''; ?>" disabled>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-3">
                      ...
                      <div class="col-lg-7">
                       <input type="text" class="form-control" name="nama" value="<?php echo isset($row['nama']) ? $row['nama'] : ''; ?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-3">
                      ...
                      <div class="col-lg-7">
                       <input type="text" class="form-control" value="<?php echo isset($row['email']) ? $row['email'] : ''; ?>" disabled>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-3">
