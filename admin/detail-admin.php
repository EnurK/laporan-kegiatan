...
<head>
  ...
  <title>BawasluDoc- Detail Admin</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800">Detail Admin <?php echo $row['nama'];?></h1>
          </div>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  <form method="post" enctype="multipart/form-data">
                    ...
                    <center>
                    <a class='btn btn-sm btn-light' href='daftar-admin.php'> Kembali </a>
                    <a class='btn btn-sm btn-danger' href='del-admin.php?id=<?php echo $row['id_admin'];?>'> Hapus Akun </a>
                    </center>
                    <hr>
                  </form>
                </div>
