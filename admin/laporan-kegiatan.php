...
<head>
  ...
  <title>BawasluDoc - Laporan kegiatan</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800">Laporan kegiatan Baru</h1>
          </div>
                  ...
                  <?php
                      ...
                      while($row = mysqli_fetch_array($data))
                      {
                          ...
                          <td>$no</td>
                          <td>".$row['subjek_kegiatan']."</td>
                          <td>".tgl_indo($row['tgl_kegiatan'])."</td>
                          <td>".$row['nama']."</td>
                          <td>
                            <a class='btn btn-sm btn-primary' href='lihat-kegiatan.php?id=".$row['id_kegiatan']."'>
