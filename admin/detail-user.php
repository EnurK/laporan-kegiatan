...
<head>
  ...
  <title>BawasluDoc- Detail user</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800">Detail user <?php echo $row['nama'];?></h1>
          </div>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      <div class="col-lg-3">
                        <label for="tgl" class="text-primary">Kecamatan</label>
                      </div>
                      <div class="col-lg-7">
                       <label class="text-default"><?php echo $row['kecamatan'];?> </label>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-3">
                    ...
                    <center>
                    <a class='btn btn-sm btn-light' href='daftar-user.php'> Kembali </a>
                    <a class='btn btn-sm btn-danger' href='del-user.php?id=<?php echo $row['id_user'];?>'> Hapus Akun </a>
                    </center>
                    <hr>
                  </form>
                </div>
