...
<head>
  ...
  <title>BawasluDoc - Daftar User</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800">Daftar Panwascam</h1>
          </div>
            ...
            <div class="card mb-4">
              <div class="card-body">
                <div class="row col-lg-12">
                  <a href="cetak-daftar-user.php" class="btn btn-sm btn-info btn-icon-split">
                    <span class="icon text-primary-50">
                      <i class="fas fa-print"></i>
                    </span>
                    <span class="text">Cetak Daftar Panwascam</span>
                  </a>
                </div>  
                ...
                ?>
                  ...
                  <?php
                      ...
                      { 
                          ...
                          <td>".$row['email']."</td>
                          <td>
                            <a class='btn btn-sm btn-info' href='detail-user.php?id=".$row['id_user']."'> Detail </a>                          </td>
                      </tr>";
                      $no++;
                      }
                  ?>
