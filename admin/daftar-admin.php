...
<head>
  ...
  <title>BawasluDoc - Daftar Admin</title>
            ...
            <div class="card mb-4">
              <div class="card-body">
                <div class="row col-lg-12">
                  <a href="cetak-daftar-admin.php" class="btn btn-sm btn-info btn-icon-split">
                    <span class="icon text-primary-50">
                      <i class="fas fa-print"></i>
                    </span>
                    <span class="text">Cetak Daftar Admin</span>
                  </a>
                </div>  
                ...
                ?>
                  ...
                  <?php
                      ...
                      { 
                          ...
                          <td>".$row['telepon']."</td>
                          <td>
                            <a class='btn btn-sm btn-info' href='detail-admin.php?id=".$row['id_admin']."'> Detail </a>  
                            <a class='btn btn-sm btn-success' href='ubah-admin.php?id=".$row['id_admin']."'> Ubah </a>                                                
                          </td>
                      </tr>";
                      $no++;
                      }
