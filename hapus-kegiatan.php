      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800">Konfirmasi Hapus kegiatan <?php echo $row['subjek_kegiatan'];?></h1>
          </div>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  <form action="add-kegiatan.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      <div class="col-lg-3">
                       <label for="subjek" class="text-primary">Temapat Kegiatan</label>
                      </div>
                      <div class="col-lg-7">
                       <label class="text-default"><?php echo $row['tempat_kegiatan'];?> </label>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-3">
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <p class="text-center">
                                  <img src="/buktifoto/images<?php echo $row['bukti_kegiatan'];?>" width="400dp" height="240dp">
                                </p>
                              </div>
                    ...
                    <br>
                    <center>
                    <a class='btn btn-sm btn-danger' href='del-kegiatan.php?id=<?php echo $row['id_kegiatan'];?>'> Hapus</a> &nbsp;
                    </center>
                    <hr>
                  </form>
                </div>
