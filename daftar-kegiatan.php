...
<head>
  ...
  <title>BawasluDoc - Daftar kegiatan</title>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  <div class="row col-lg-12">
                    <a href="create-kegiatan.php" class="btn btn-sm btn-outline-dark btn-icon-split">
                    ...
                    <table class="table align-items-center table-bordered table-flush table-hover" id="tabel-kegiatan">
                      ...
                      <tbody>
                        ...
                        if (isset($_SESSION['id_user'])) {
                          ...
                          $data = mysqli_query($koneksi, "SELECT * FROM tbl_kegiatan WHERE id_user='$idm'");
